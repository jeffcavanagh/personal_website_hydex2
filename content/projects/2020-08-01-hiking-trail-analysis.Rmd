...
This data set gives information on trails in the National Parks Service. The data is publically available on Kaggle.com.
...
The mean value of average trail ratings was 4.17. To predict the highest tier of terms, the response variable average rating was turned into a classification variable with levels: avg_rating>4.5, and avg_rating$\leq$4.5.
