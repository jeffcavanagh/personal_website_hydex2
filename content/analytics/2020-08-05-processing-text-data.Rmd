...
The most common words are unsuprisingly the filler words used found in any text. To sort these words out we will use the `stop_words` dataframe, which is a list of these common words.
